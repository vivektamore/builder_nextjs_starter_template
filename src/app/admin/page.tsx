...
import { PlusIcon, EditIcon, TrashIcon, EyeIcon, BarChart3Icon, UsersIcon, FileTextIcon, ImageIcon } from 'lucide-react'
...
export const metadata = {
  title: 'Admin Dashboard - Search Engine Journal',
  description: 'Admin dashboard for managing articles, web stories, and analytics',
  robots: {
    index: false,
    follow: false,
  }
